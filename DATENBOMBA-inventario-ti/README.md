...
- **Dados 100% Locais:** Nenhum dado de patrimônio ou número de série trafega para servidores externos ou serviços de terceiros. As informações residem exclusivamente no armazenamento seguro do navegador (`localStorage`) daquele aparelho.
- **Conformidade:** Adequado para ambientes corporativos e políticas de segurança da informação (como LGPD), já que não há risco de vazamento em nuvem.
- **Backup:** Recomenda-se realizar a exportação da planilha CSV ao final de cada dia de inventário para arquivar ou consolidar em rede.
